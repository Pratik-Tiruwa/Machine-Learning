...
# Convert catrgorical data into numeric using factorization
...
# Use OneHotEncoder to encode catrgorical features
...
# Fit the classifier to the training sets
...
sample_input_encoder = encoder.transform(pd.DataFrame(sample_input))

# Make Prediction for the sample input
sample_prediction = clf.predict(sample_input_encoder)

# Print the Prediction
if sample_prediction[0] == 'No':
    print("Preiction : No, dont play tennis.")
else:
